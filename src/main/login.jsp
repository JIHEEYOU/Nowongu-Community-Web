...
<div class="col-lg-offset-4 col-lg-4">'
	<div class="jumbortron" style="padding-top: 15px; ">
		<form action="login_process.jsp" method="post">
			...
			<p><a href="login_process.jsp"><input type="submit" class="btn btn-primary form-control" value="로그인"></a></p>
			<p><a href="join.jsp"><input type="submit" class="btn btn-primary form-control" value="회원가입"></a></p>
		</form>
	</div>
</div>	
</div>
